...
def push_files_to_github():
    ...
    try:
        ...
        st.success("✅ All files pushed to GitHub successfully!")
...
# -------------------- OTHER PAGES -------------------- #
# Add your Add Income, Add Expense, View Data, Monthly/Yearly Comparison code here exactly as before


# -------------------- Other pages (Add Income, Add Expense, etc.) -------------------- #
